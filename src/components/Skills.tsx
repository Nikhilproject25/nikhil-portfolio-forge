    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {skillCategories.map((category, index) => (
          <div 
            key={category.title}
            className="bg-gray-800 rounded-lg p-4 lg:p-6 hover:bg-gray-750 transition-colors duration-300"
          ...
          >
            ...
            <div className="space-y-2">
              {category.skills.map((skill) => (
                <div 
                  key={skill}
                  className="bg-blue-600/20 text-blue-300 px-3 py-2 rounded-lg text-xs lg:text-sm font-medium hover:bg-blue-600/30 transition-colors duration-200"
                >
                  {skill}
                </div>
              ))}
